...
// definicion de valores para armar el dto de la compra
...
window.AbrirModal = async function () {
  ...
  console.log("Antes del display", modal);
  ...
  console.log("Después del display");
...
function CerrarModal() {
  ...
  // Restaurar interacción con el fondo
...
btnSave.addEventListener("click", async () => {
  ...
  // Mapeamos los detalles sin el nombre para el dto
