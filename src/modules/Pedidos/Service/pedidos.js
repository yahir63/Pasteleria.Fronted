document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("click", (e) => {
    ...
    // ================= NUEVO PEDIDO =================
    if (btnNuevo) {
      modalContent.classList.remove("modal-small", "modal-medium");
      ...
      const html = `
        ...
        <div class="modal-body">
          <div class="form-grid">
            ...
            <div class="form-group">
              <label>Cliente</label>
              <select>
                <option>Rafaela Ramirez</option>
                <option>Jafet Sanchez</option>
                <option>Juan Lopez</option>
                <option>Rosa Aguirre</option>
              </select>
            </div>
            <div class="form-group">
                  ...
                  <td>
                    <div style="display:flex; gap:6px; justify-content:center;">
                      <button class="edit-detail-btn" style="background:#07729C;color:white;border:none;padding:6px 12px;border-radius:6px;cursor:pointer;font-size:12px;display:flex;align-items:center;gap:5px;">
                        <img src="/src/modules/Shared/Assets/img/editar.png" alt=""> Editar
                      </button>
                      <button class="delete-detail-btn" style="background:#dc3545;color:white;border:none;padding:6px 12px;border-radius:6px;cursor:pointer;font-size:12px;display:flex;align-items:center;gap:5px;">
                        <img src="/src/modules/Shared/Assets/img/eliminar.png" alt=""> Eliminar
                      </button>
                    </div>
                  </td>
                </tr>
        ...
        <div class="modal-footer">
          <div class="total-box">
            <span>Total:</span>
            <input type="text" value="C$ 0.00" readonly>
          </div>
          ...
          <button id="btn-savePedido" class="btn-save"><img src="/src/modules/Shared/Assets/img/guardar.png" /> Guardar Pedido</button>
        </div>
      `;
          ...
          abrirModal(`
            <div style="text-align:center; padding:15px;">
              ...
              <div style="display:flex; gap:10px; justify-content:center; margin-top:15px;">
                ...
                <button id="confirm-cancel" style="background:#dc3545;color:white;border:none;padding:9px 18px;border-radius:8px;cursor:pointer;font-size:14px;">🗑️ Cancelar Pedido</button>
              </div>
            </div>
          `, "small");
          setTimeout(() => {
    ...
    if (e.target.closest(".edit-detail-btn")) {
      ...
      abrirModal(`
        <div class="modal-header">
          <h2><img src="/src/modules/Shared/Assets/img/editar.png" alt=""> Editar Detalle</h2>
        </div>
        <div class="modal-body">
          <div class="form-grid">
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" id="edit-precio" value="${precioActual}">
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <button id="btn-cancelEdit" class="btn-cancel">Cancelar</button>
          <button id="btn-saveEdit" class="btn-save"><img src="/src/modules/Shared/Assets/img/guardar.png" /> Guardar Cambios</button>
        </div>
      `, "large");
